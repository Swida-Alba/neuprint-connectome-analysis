...
# Canonical applied-threshold formula lives in utils.threshold_state so
# Cross-Dataset Comparison shares the exact same numbers; re-exported
# here for the historical coana.applied_threshold_provenance import path.
try:
